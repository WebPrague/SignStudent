 ...
 * 
 * @see com.webprague.StudentSign.pojo.User
...
public class UserDAO extends BaseHibernateDAO {
	...
	public static final String WORK_CHARACTER = "workCharacter";
	...
	public User findById(Integer id) {
		...
		try {
			User instance = (User) getSession().get(
					"com.webprague.StudentSign.pojo.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.webprague.StudentSign.pojo.User")
	...
	public List findByWorkPlace(Object workPlace) {
		return findByProperty(WORK_PLACE, workPlace);
	}

	public List findByWorkCharacter(Object workCharacter) {
		return findByProperty(WORK_CHARACTER, workCharacter);
	}
