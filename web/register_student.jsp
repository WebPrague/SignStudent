		...
		<div class="main">
			...
			<div class="input_form">
				<form id="register_form" method="post" onkeypress="if(event.keyCode==13||event.which==13){ register();}">
                    ...
                    <input placeholder="电话" type="text" name="phonenumber">
                    <input placeholder="微信" type="text" name="wechat">
                    <input placeholder="QQ" type="text" name="qq">
                    <input placeholder="工作地点" type="text" name="workplace">
                    <input placeholder="工作性质" type="text" name="workcharacter">
			...
			<div class="ckeck-bg">
				<div class="checkbox-form">
                    <div class="check-left">
							<input onclick="location='register_teacher.java'" type="submit" value="教工注册">
					</div>
            ...
            <div class="ckeck-bg">
				<p><a href="login.java">&lt;&lt;&lt;返回登录界面</a></p>
			</div>
		</div>
		<div class="footer">
		</div>
